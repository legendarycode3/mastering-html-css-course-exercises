...
1. **Media Queries**: <br/>
   ...
   1ii.) They enable the creation of "breakpoints," which are specific screen sizes where the layout or styling changes to better suit the device. CSS Media Queries enable web pages to adjust their layout and styles based <br/>
